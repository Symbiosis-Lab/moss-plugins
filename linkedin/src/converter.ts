/**
 * Content conversion: LinkedIn HTML <-> Markdown.
 *
 * LinkedIn articles use standard semantic HTML:
 * p, h2, h3, strong, em, a, img, ul, ol, li, blockquote, pre, code
 *
 * The conversion logic is the same as Substack's since both platforms
 * produce standard HTML article content.
 */

/**
 * Convert LinkedIn article HTML to Markdown.
 */
...
/**
 * Convert Markdown to HTML suitable for LinkedIn's article editor.
